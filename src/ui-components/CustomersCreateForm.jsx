...
export default function CustomersCreateForm(props) {
  ...
  const resetStateValues = () => {
    ...
    setAccountIds(initialValues.accountIds);
    setCurrentAccountIdsValue("");
    setApproverGroupIds(initialValues.approverGroupIds);
    ...
    setPermissionSet(initialValues.permissionSet);
    setRoleStatus(initialValues.roleStatus);
    setRoleArn(initialValues.roleArn);
    setExternalId(initialValues.externalId);
    setCloudFormationTemplate(initialValues.cloudFormationTemplate);
    setInvitationToken(initialValues.invitationToken);
    setInvitationSentAt(initialValues.invitationSentAt);
    setInvitationExpiresAt(initialValues.invitationExpiresAt);
    setApprovedAt(initialValues.approvedAt);
    setRoleEstablishedAt(initialValues.roleEstablishedAt);
    setLastRoleVerification(initialValues.lastRoleVerification);
    setRoleVerificationError(initialValues.roleVerificationError);
    setErrors({});
  };
