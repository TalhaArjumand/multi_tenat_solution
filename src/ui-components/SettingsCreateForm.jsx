...
export default function SettingsCreateForm(props) {
  ...
  const resetStateValues = () => {
    ...
    setSesNotificationsEnabled(initialValues.sesNotificationsEnabled);
    setSnsNotificationsEnabled(initialValues.snsNotificationsEnabled);
    setSlackNotificationsEnabled(initialValues.slackNotificationsEnabled);
    setSlackAuditNotificationsChannel(
      initialValues.slackAuditNotificationsChannel
    );
    setSesSourceEmail(initialValues.sesSourceEmail);
    setSesSourceArn(initialValues.sesSourceArn);
    setSlackToken(initialValues.slackToken);
    setTeamAdminGroup(initialValues.teamAdminGroup);
    setTeamAuditorGroup(initialValues.teamAuditorGroup);
    setTeamCustomerAdminGroup(initialValues.teamCustomerAdminGroup);
    setActivationMode(initialValues.activationMode);
    setErrors({});
  };
  const validations = {
    id: [{ type: "Required" }],
